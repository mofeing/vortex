...
void CacheSim::step() {
  ...
  std::cout << timestamp << ": rst=" << static_cast<bool>(cache_->reset) << std::endl;
...
bool CacheSim::get_split() {
  return cache_->split_en;
}

void CacheSim::set_split(bool en) {
  cache_->split_en = en;
}
